                                ...
                                <td class="d-flex justify-content-center align-items-center">
                                    ...
                                    <div class="dropdown">
                                        ...
                                        <ul class="dropdown-menu" aria-labelledby="dropdownMenuButton1">
                                            ...
                                            <li>
                                                <a class="dropdown-item" href="#"><span class="iconify mr-1" data-icon="fluent:delete-20-regular"></span>Eliminar</a>
                                            </li>
                                            ...
                                            <li>
                                                <a class="dropdown-item" href="#"><span class="iconify mr-1" data-icon="cil:print"></span>Imprimir Expediente</a>
                                            </li>
                                        </ul>
                                    </div>
                                </td>
